...
The best thing you can do for future self is to write both tests and documentation about your project. This section explains how to structure and organize documentation in your project.
...
We use the next structure:
   ...
   - **project/** -
     this directory is for `*.rst` files associated with your project (this can include auto-generated docs, business logic, etc.)
